    ...
    <div>
        ...
        <div className="py-10 lg:px-14 px-5">
          <div>
            ...
            <p className="my-5 text-sm">
              Smart Abacus <strong>offers</strong> tailored courses to boost{" "}
              <strong>mental calculation, concentration</strong>, and{" "}
              <strong>problem-solving skills</strong>.
            </p>
          </div>
          <div className="grid lg:grid-cols-3 grid-cols-1 gap-3">
            {OurCources.map((courses, index) => {
              const { id, image, dotimg, coursename, course, text, btn } =
                courses;
              return (
                <div className="course_level" key={id}>
                  ...
                  <div className="course_div group absolute bottom-0 py-5 right-0 w-full h-full grid place-content-end px-4 place-items-end">
                    ...
                    <h2 className="course_heading" title={coursename}>
                      {coursename}
                    </h2>
                    <div className="group-hover:block hidden w-60 text-left">
                      <h4 className="para-text text-[var(--White)]">
                        {course}
                      </h4>
                      <p className="course-info text-[var(--White)]">{text}</p>
                      <a href="#">
                        <CustomButton color="--secondary-color" label={btn} />
                      </a>
                    </div>
                  </div>
                </div>
        ...
        <div className="py-10 lg:px-14 px-5 bg-[var(--footer-bg-color)]">
          <div>
            ...
            <p className="my-5 text-sm">
              Unlock faster{" "}
              <strong>
                calculations, sharper memory, and unstoppable confidence
              </strong>{" "}
              with the power of Japanese Abacus. A fun and <br /> proven way to{" "}
              <strong>boost</strong> academic <strong>success</strong>!
            </p>
          </div>
      ...
      <section className="py-10 lg:px-14 px-5 relative">
        <img
          src={imageChildgame}
          alt="Child Game"
          className="absolute lg:left-14 -left-5 lg:top-32 top-72  -z-10"
        />
        <img
          src={imagePaperplan}
          alt="Paper Plan"
        ...
        <div>
          ...
          <p className="my-5 text-sm">
            Our students and parents <strong>love</strong> the{" "}
            <strong>transformational</strong> impact of Abacus{" "}
            <strong>learning</strong>! From faster calculations to better{" "}
            <strong>focus</strong> <br />
            and <strong>confidence</strong>, hear how Smart Abacus is shaping{" "}
            <strong>young minds</strong> for <strong>success</strong>.
          </p>
        </div>
        <Slider />
      </section>
